...
export class FinanceHomeComponent implements OnInit {
  ...
  edit(id:any){
    this.router.navigate(['/main/home/finance'],{queryParams: {id:id}});
}
...
delete(id:any){
 const dialogRef = this.dialog.open(DeleteComponent, {
   ...
   data: {
    ...
    //  title:'Hey, do you really want to delete this HR requirement?',
     heading:'Hey, do you really want to delete this finance?',
     report:'Yes, delete',
     cancel:'Go, back'
   }
 });
