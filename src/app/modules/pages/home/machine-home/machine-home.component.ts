...
@Component({
  selector: 'app-machine-home',
  templateUrl: './machine-home.component.html',
  styleUrls: ['./machine-home.component.scss']
})
export class MachineHomeComponent implements OnInit {
  updateData: any;
  post_id: any;
  profileDetails: any;
  ...
  edit(id:any){
    this.router.navigate(['/main/home/machine-requirement'],{queryParams: {id:id}});
}
...
delete(id:any){
 const dialogRef = this.dialog.open(DeleteComponent, {
   ...
   data: {
     ...
     heading:'Hey, do you really want to delete this Machine? ',
     report:'Yes, delete',
     cancel:'Go, back'
   }
 });
