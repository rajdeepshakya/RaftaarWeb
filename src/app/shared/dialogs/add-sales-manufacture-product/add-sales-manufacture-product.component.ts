...
@Component({
  selector: 'app-add-sales-manufacture-product',
  templateUrl: './add-sales-manufacture-product.component.html',
  styleUrls: ['./add-sales-manufacture-product.component.scss']
})
export class AddSalesManufactureProductComponent implements OnInit {
  ...
  constructor(private dialog :MatDialog,
     public dialogRef: MatDialogRef<AddSalesManufactureProductComponent>,
